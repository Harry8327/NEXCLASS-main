...
def teacher_dashboard():
    ...
    with col2:
        ...
        if st.button("Logout",type="secondary",key="loginbackbtn1",shortcut="control+backspace"):
...
def teacher_screen_login():
    ...
    teacher_username=st.text_input("Enter Username",placeholder="@harry27")
    teacher_pass=st.text_input("Enter Password",type='password',placeholder="Enter your password")
    st.divider()

    btn1,btn2=st.columns(2)
    with btn1:
        if st.button("Login",icon=":material/passkey:",shortcut='control+enter',type='primary',width="stretch"):
...
def teacher_screen_register():
    ...
    teacher_username=st.text_input("Enter Username",placeholder="@harry27")
    teacher_name=st.text_input("Enter Name",placeholder="Harsh")
    teacher_pass=st.text_input("Enter Password",type='password',placeholder="Enter your password")
    ...
    btn1,btn2=st.columns(2)
    with btn1:
        if st.button("Register",icon=":material/passkey:",type='primary',width="stretch"):
