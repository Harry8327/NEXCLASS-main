...
def student_dashboard():
    ...
    for i,sub_node in enumerate(subjects):
        ...
        def unenroll_btn(sid=sid, sub_name=sub['name']):
...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name=st.text_input("Enter your name",placeholder="E.g. Harsh Goyal ")
            ...
            try:
                audio_data=st.audio_input("Record A Short Phrase, like My name is Harsh,I'm Present")
                ...
                if new_name:
                    with st.spinner("Creating Profile..."):
                        ...
                        if encoding:
                            ...
                            voice_emb=None
                            if audio_data:
                                voice_emb=get_voice_embedding(audio_data.read()) # .read() for binary data conversion
